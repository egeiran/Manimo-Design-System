...
- **[HUMAN] Re-run `npm run publish norton-equivalent non-inverting-op-amp shift-register ohms-law zener-clipper two-to-four-decoder rc-charging cmos-inverter hexadecimal-counting rl-transient integrator-op-amp jk-flip-flop source-transformations rlc-resonance binary-addition`** once Supabase env vars are available on the nightly sandbox. The 2026-05-18 PM nightly run added three more ADE scenes (Source Transformations ch.3, RLC Resonance ch.8, Binary Addition ch.5) that the reviewer should publish after merge. Reviewer flagged on 2026-05-15 (extended 2026-05-17 PM, 2026-05-18 PM, 2026-05-18 PM-late).
...
- **ADE chapter map** (Supabase `public.chapters` for `subject_id='ade'`, 10 chapters as of 2026-05-13): ch.1 Kretsteori, ch.2 Energi og effekt, ch.3 Superposisjon og Thévenin, ch.4 Dioder, ch.5 Digital elektronikk, ch.6 Transistorer, ch.7 Minne og register, ch.8 Reaktive elementer, ch.9 Operasjonsforsterker, ch.10 Digital design. Current scene coverage (after the 2026-05-18 PM-late run): ch.1 (KVL, voltage-divider, KCL, ohms-law), ch.2 (capacitor-energy, inductor-energy, max-power-transfer, joule-heating), ch.3 (Thévenin, Norton, superposition, **source-transformations** — added tonight), ch.4 (half-wave-rectifier, full-wave-bridge-rectifier, zener-clipper), ch.5 (NAND universality, two's-complement, hexadecimal-counting, **binary-addition** — added tonight), ch.6 (mosfet-switch, bjt-load-line, cmos-inverter), ch.7 (D flip-flop, shift-register, SR latch, jk-flip-flop), ch.8 (phasor-rotation, low-pass-bode, rc-charging, rl-transient, **rlc-resonance** — added tonight), ch.9 (inverting op-amp, non-inverting op-amp, summing-amplifier, integrator-op-amp), ch.10 (K-map, FSM, multiplexer-4-to-1, 2-to-4 decoder). Most under-served chapters now: ch.4 (3 scenes — candidates: diode I-V curve, photodiode / Schottky, voltage doubler), ch.6 (3 scenes — candidates: BJT current-mirror, CMOS NAND/NOR). Other strong follow-ups: full adder / ripple carry (ch.10 — pending PR #20 resolution), T flip-flop (ch.7), AC impedance triangle (ch.8), mesh / nodal analysis (ch.3), ASCII / character codes (ch.5).
