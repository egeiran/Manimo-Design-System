  ...
  if (kind === 'circuit') {
    return (
      <svg viewBox="0 0 80 45" width="100%" height="100%">
        ...
        <path d="M 14 22 H 26 V 14 H 38 V 22 H 50" stroke="var(--amber-400)" strokeWidth="1.2" fill="none"/>
        <rect x="50" y="16" width="3" height="12" fill="var(--teal-400)"/>
        <rect x="56" y="14" width="3" height="16" fill="var(--teal-400)"/>
        <path d="M 60 22 H 70 V 32 H 14 V 22" stroke="var(--amber-400)" strokeWidth="1.2" fill="none"/>
      </svg>
    );
  }
  if (kind === 'curve') {
    return (
      <svg viewBox="0 0 80 45" width="100%" height="100%">
        ...
        <path d="M 10 35 Q 24 35 32 22 T 74 11" stroke="var(--amber-400)" strokeWidth="1.4" fill="none"/>
      </svg>
    );
  }
  if (kind === 'formula') {
    return (
      <svg viewBox="0 0 80 45" width="100%" height="100%">
        <rect width="80" height="45" fill="#0c0a1f"/>
        <text x="40" y="27" fontFamily="Fraunces, serif" fontStyle="italic" fontSize="10" fill="var(--chalk-50)" textAnchor="middle">τ = RC</text>
      </svg>
    );
  }
  if (kind === 'recap') {
