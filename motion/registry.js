...
window.ManimoRegistry = {
  ...
  'label': {
    ...
    props: {
      ...
      fontFamily: { type: 'string', default: 'var(--font-serif)', control: 'text', label: 'Font (serif/mono/sans)' },
      italic:     { type: 'boolean', default: true, control: 'toggle', label: 'Italic' },
  ...
  'code-block': {
    ...
    keywords: ['code', 'pseudocode', 'snippet', 'program', 'monospace', 'syntax'],
    description: 'A monospace code panel; reveal line-by-line or spotlight lines.',
    container: 'dom',
    defaultBox: { w: 560, h: 300 },
    props: {
      code:      { type: 'string', default: 'function f(x):\n  return x', control: 'text', label: 'Code (\\n for lines)' },
      title:     { type: 'string', default: '', control: 'text', label: 'Title' },
      highlight: { type: 'string', default: '', control: 'text', label: 'Highlight lines (e.g. 2,3)' },
      reveal:    { type: 'string', default: 'all', control: 'text', label: 'Reveal (all/lines)' },
      fontSize:  { type: 'number', default: 18, control: 'number', label: 'Font size', min: 9, max: 40, step: 1 },
      accent:    { type: 'color',  default: 'var(--amber-400)', control: 'token', label: 'Accent' },
      duration:  { type: 'number', default: 1.2, control: 'number', label: 'Reveal (s)', min: 0, max: 8, step: 0.1 },
      delay:     { type: 'number', default: 0,   control: 'number', label: 'Delay (s)', min: 0, max: 10, step: 0.1 },
    },
  },
